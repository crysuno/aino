...
[![Deploy to DigitalOcean](https://www.deploytodo.com/do-btn-blue.svg)](https://cloud.digitalocean.com/apps/new?repo=https://github.com/crysuno/aino/tree/main)
...
1. Edit `src/pages/index.js` and replace "Hi people" with a different greeting
